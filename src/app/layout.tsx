...
const appUrl =
  ...
  (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'http://localhost:7820');

export const metadata: Metadata = {
  metadataBase: new URL(appUrl),
  title: {
    default: 'Komtru Operations',
    template: '%s · Komtru Operations',
  },
  description: 'Internal operations console for Komtru.',
  applicationName: 'Komtru Operations',
